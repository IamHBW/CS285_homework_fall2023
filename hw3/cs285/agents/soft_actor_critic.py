...
class SoftActorCritic(nn.Module):
    ...
    def update_critic(
        ...
        # Compute loss
        loss: torch.Tensor = nn.functional.mse_loss(q_values,target_values)
    ...
    def update(
        ...
        critic_infos = [self.update_critic(observations,actions,rewards,next_observations,dones) for k in range(self.num_critic_updates)]
